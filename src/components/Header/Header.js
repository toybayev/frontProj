...
const Header = ({ onSearch, cartCount }) => {
    ...
    const [menuOpen, setMenuOpen] = useState(false); // Для профиля
    const [burgerOpen, setBurgerOpen] = useState(false); // Для бургера
        ...
        <header className="bg-white shadow-md">
            <div className="container mx-auto px-4 flex items-center h-16 justify-between">
                ...
                <div className="hidden lg:flex items-center justify-between w-full">
                    ...
                    <div className="search-container relative mx-4 flex items-center max-w-xl">
                        <input
                            type="text"
                    ...
                    <div className="flex items-center space-x-6 avatar">
                        {isAuthenticated ? (
            ...
            {/* Мобильное меню */}
            {burgerOpen && (
                <div className="lg:hidden bg-white shadow-md absolute w-full z-10">
                    <div className="flex flex-col items-start p-4">
                        <button
                            onClick={() => navigate('/')}
                            className="py-2 text-gray-700 w-full text-left hover:bg-gray-100"
                        >
                            Home
                        </button>
                        <button
                        ...
                        {isAuthenticated ? (
                            ...
                            <>
                                ...
                                <button
                                    onClick={() => navigate('/register')}
                                    className="py-2 text-teal-500 w-full text-left hover:bg-gray-100"
                                >
                                    Sign Up
                                </button>
                            </>
